...
router.post('/inventory', ...allUsers, createUploader('inventories', [{ name: 'filePath', maxCount: 1 }]), upsertInventory, smartInvalidateCache());
router.put('/:inventoryId/inventory', ...allUsers, createUploader('inventories', [{ name: 'filePath', maxCount: 1 }]), upsertInventory, smartInvalidateCache());
