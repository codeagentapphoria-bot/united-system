...
import { User, Shield, Phone, Mail, Briefcase, GraduationCap, ChevronRight, Check, ArrowLeft } from 'lucide-react';
        ...
        <aside className="hidden md:flex w-72 lg:w-80 flex-col flex-shrink-0 bg-primary-800 text-white p-8 overflow-y-auto">
          <div className="mb-8">
            <button
              type="button"
              onClick={() => navigate(-1)}
              className="flex items-center gap-1.5 text-primary-300 hover:text-white text-sm mb-4 transition-colors"
            >
              <ArrowLeft size={15} />
              Back
            </button>
          ...
          <div className="max-w-4xl mx-auto px-6 py-8">
            ...
            <div className="md:hidden mb-6">
              <button
                type="button"
                onClick={() => navigate(-1)}
                className="flex items-center gap-1.5 text-gray-500 hover:text-gray-800 text-sm mb-3 transition-colors"
              >
                <ArrowLeft size={15} />
                Back
              </button>
                          ...
                          >
                            {photoPreview ? (
                              ...
                              <div className="text-center p-2 group-hover:text-primary-500 transition-colors">
                                <User className="w-8 h-8 text-gray-300 group-hover:text-primary-500" />
                              </div>
                            )}
                          </div>
