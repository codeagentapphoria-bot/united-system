...
// Custom Components
import { AddStudentModal, DeleteStudentModal, EditStudentModal } from '@/components/modals/social-amelioration';
import { BeneficiaryCard, StatusBadge } from '@/components/social-amelioration/shared';
            ...
            <div className="flex-1">
              ...
              <div className="flex items-center gap-6">
                <div className="flex items-center gap-2">
                  <span className="text-sm font-semibold text-gray-700 bg-gray-200 px-2 py-1 rounded">Student ID:</span>
                  <span className="text-sm font-bold text-heading-800 font-mono bg-white px-2 py-1 rounded border">{beneficiary.studentId}</span>
                </div>
...
export const StudentsTab: React.FC = () => {
  ...
  const getProgramNames = (programIds: string[] | undefined): string[] => {
    ...
    return programIds
      .map((id: string) => allGovernmentPrograms.find((p: { id: string; name: string }) => p.id === id)?.name)
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <Card className="lg:col-span-1 overflow-visible">
          <CardHeader>
            <CardTitle className="text-heading-700 text-lg">Students List</CardTitle>
            ...
            <div className="flex justify-between items-center mt-3 text-sm text-gray-600">
              <span>Total: {beneficiaries.length} students</span>
            </div>
          </CardHeader>
        ...
        {/* Right: Selected Student Information */}
        <Card className="lg:col-span-2">
          <CardHeader>
            <div className="flex items-center justify-between">
              <CardTitle className="text-heading-700 text-lg">Student Information</CardTitle>
              {selectedBeneficiary && (
          ...
          <CardContent className="max-h-[600px] overflow-y-auto">
            {selectedBeneficiary ? (
              ...
              <div className="text-center text-gray-500 py-12">
                <FiBookOpen className="h-16 w-16 mx-auto mb-4 text-gray-300" />
                <p className="text-lg">Select a student to view details</p>
              </div>
            )}
          </CardContent>
