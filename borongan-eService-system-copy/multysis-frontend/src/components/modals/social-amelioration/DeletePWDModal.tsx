...
export const DeletePWDModal: React.FC<DeletePWDModalProps> = ({
  open,
  onClose,
  onConfirm,
  beneficiaryName,
        ...
        <div className="space-y-4">
          ...
          <div className="text-center">
            <p className="text-gray-700 mb-2">
              Are you sure you want to remove this PWD beneficiary?
            </p>
