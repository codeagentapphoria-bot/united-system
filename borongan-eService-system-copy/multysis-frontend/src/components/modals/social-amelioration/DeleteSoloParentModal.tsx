...
interface DeleteSoloParentModalProps {
  open: boolean;
  onClose: () => void;
  onConfirm: () => void;
...
export const DeleteSoloParentModal: React.FC<DeleteSoloParentModalProps> = ({
  open,
  onClose,
  onConfirm,
  beneficiaryName,
      ...
      <DialogContent className={cn('max-w-md')}>
        <DialogHeader>
          <DialogTitle className={cn('text-xl font-semibold flex items-center gap-2 text-red-600')}>
            ...
            Remove Solo Parent Beneficiary
          </DialogTitle>
        </DialogHeader>
        ...
        <div className="space-y-4">
          ...
          <div className="text-center">
            <p className="text-gray-700 mb-2">
              Are you sure you want to remove this solo parent beneficiary?
            </p>
