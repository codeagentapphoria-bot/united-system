...
// Types and Schemas
import { changeOwnPasswordSchema, type ChangeOwnPasswordInput } from '@/validations/user.schema';
...
export const ChangeOwnPasswordModal: React.FC<ChangeOwnPasswordModalProps> = ({
  ...
  const handleSubmit = (data: ChangeOwnPasswordInput) => {
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-6 pb-6">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <CustomFormLabel required>Current Password</CustomFormLabel>
                    <FormControl>
                      <PasswordInput
                        {...field}
